...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **分类字典** | `category:manage` | 维护分类字典树（增删改） | ❌ | ✅ | ✅ |
| **图书检索** | `book:view` | 检索图书目录、查看图书与副本详情 | ✅ | ✅ | ✅ |
| **图书编目** | `book:create` | 录入新书书目元数据 | ❌ | ✅ | ✅ |
| **图书修改** | `book:update` | 修改书名、简介、封面等 | ❌ | ✅ | ✅ |
| **图书下架** | `book:delete` | 彻底删除无单册的书目 | ❌ | ❌ | ✅ |
| **单册管理** | `book:copy:manage`| 添加单册、调整架位、状态变更与报废注销 | ❌ | ✅ | ✅ |
| **封面上传** | `book:cover:upload` | 上传图书封面图片资源 | ❌ | ✅ | ✅ |
| **批量导入** | `book:import` | **Excel 批量导入图书与条形码 (Stage 2-C)** | ❌ | ✅ | ✅ |
